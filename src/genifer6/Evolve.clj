...
(defn binaryTourament(pop: Array[String]): String = {
...
(defn pointMutation(dna: String, rate: Float = 1.0f / 64): String = {
...
(defn crossover(parent1: String, parent2: String, rate: Float): String = {
    if (r.nextFloat() > rate)
      return parent1
...
(defn reproduce(selected: Array[String], popSize: Int, crossRate: Float, mutationRate: Float): Array[String] = {
...
(defn printCandidate(c: String): Unit = {
    println(c + " <" + fitness(c) + ">")
}
...
;; point where user pressed mouse button (-1 for none)
  ...
  val drawingPanel = new Panel {
    ...
    override (defn paint(g : Graphics2D) {
